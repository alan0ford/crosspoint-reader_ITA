...
ruby -rdigest -e 'puts [
  ...
  "./caecilia_12_bold.h",
  "./caecilia_12_bolditalic.h",
  "./caecilia_12_italic.h",
].map{|f| Digest::SHA256.hexdigest(File.read(f)).to_i(16) }.sum % (2 ** 32) - (2 ** 31)'
))"
...
ruby -rdigest -e 'puts [
  ...
  "./caecilia_14_bold.h",
  "./caecilia_14_bolditalic.h",
  "./caecilia_14_italic.h",
].map{|f| Digest::SHA256.hexdigest(File.read(f)).to_i(16) }.sum % (2 ** 32) - (2 ** 31)'
))"
...
ruby -rdigest -e 'puts [
  ...
  "./caecilia_16_bold.h",
  "./caecilia_16_bolditalic.h",
  "./caecilia_16_italic.h",
].map{|f| Digest::SHA256.hexdigest(File.read(f)).to_i(16) }.sum % (2 ** 32) - (2 ** 31)'
))"
...
ruby -rdigest -e 'puts [
  ...
  "./caecilia_18_bold.h",
  "./caecilia_18_bolditalic.h",
  "./caecilia_18_italic.h",
].map{|f| Digest::SHA256.hexdigest(File.read(f)).to_i(16) }.sum % (2 ** 32) - (2 ** 31)'
))"
